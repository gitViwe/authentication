...
public interface IPasskeyManager
{
    ...
    Task<bool> RegisterCredentialAsync(string userId, string? friendlyName, CredentialCreateOptions originalOptions, AuthenticatorAttestationRawResponse response, CancellationToken cancellationToken);
